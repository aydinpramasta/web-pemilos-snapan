...
if(isset($_POST['simpan'])) {
  ...
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          ...
          mysqli_query($koneksi,"INSERT INTO tbl_mpk(kode_akses, nomor_paslon)
          ...
          $( document ).ready(function() {
            Swal.fire({
               icon: 'success',
               title: '<h4 class=\"display-3 fw-bold\">' + 'Berhasil' + '</h4>',
              iconColor: '#08387f',
...
<html lang="en">
   <head>
      ...
      />
      <title>Pemilihan Ketua & Wakil Ketua MPK SMKN 8 Semarang</title>
         ...
         <div class="container px-3" style="height: 100%">
            ...
            <div class="container mt-3 px-3 pb-7">
               <div id="input" class="row gap-2 justify-content-lg-around">
                  <?php
                        $data_mpk = mysqli_query($koneksi,"SELECT * FROM data_mpk");
                        while($d = mysqli_fetch_array($data_mpk)){
                  ?>
                     ...
                     <label class="card">
                        ...
                        <span class="row p-2 m-0 gap-2 plan-details">
                           ...
                           <div
                              ...
                              "
                           >
                              <h6 class="display-6 fw-bold mt-1">Paslon <?= $d['no_urut']; ?></h6>
                              <h4 class="display-4 max-line fw-medium mt-1">
                                 <?= $d['nm_paslon_ketua']; ?> & <?= $d['nm_paslon_wakil']; ?>
                              </h4>
         ...
         <div class="modal-dialog modal-dialog-centered mx-3 mx-sm-auto">
            <div class="modal-content px-2 py-3 m-0">
               ...
               >
                  ...
                  <button type="submit" name="simpan" value="Vote" class="btn btn-primary py-2 px-5">
                     Yakin Pilih
                  </button>
               </div>
            </div>
